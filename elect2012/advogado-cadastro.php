						...
						<form class="well" method="post" action="<?php print ($objeto)? "advogado-cadastro.php?codigo=".$objeto->cod_advogado:"advogado-cadastro.php"; ?>">
							...
							<fieldset >
								...
								<div class="control-group">
									...
									<div class="controls">
										<label class="radio">
											<input type="radio" name="eleicoesAnt" value="1" <?php print((!is_null($objeto)) and $objeto->eleicoesAnt == "1")? "checked":""; ?>>Sim<br>
										</label>
										<label class="radio">										
											<input type="radio" name="eleicoesAnt" value="2" <?php print((!is_null($objeto)) and $objeto->eleicoesAnt == "2")? "checked":""; ?>>Não</label>
									</div>										      
								</div>
								<div class="control-group">
									...
									<div class="controls">
										<label class="checkbox">
											<input type="checkbox" name="eleicoesAntAnos[]" value="2002" <?php print((!is_null($objeto)) and $objeto->eleicoesAntAnos == "2002")? "checked":""; ?>>2002
										</label>
										<label class="checkbox">										
											<input type="checkbox" name="eleicoesAntAnos[]" value="2004" <?php print((!is_null($objeto)) and $objeto->eleicoesAntAnos == "2004")? "checked":""; ?>>2004
										</label>
										<label class="checkbox">										
											<input type="checkbox" name="eleicoesAntAnos[]" value="2006" <?php print((!is_null($objeto)) and $objeto->eleicoesAntAnos == "2006")? "checked":""; ?>>2006
										</label>
										<label class="checkbox">										
											<input type="checkbox" name="eleicoesAntAnos[]" value="2008" <?php print((!is_null($objeto)) and $objeto->eleicoesAntAnos == "2008")? "checked":""; ?>>2008
										</label>
										<label class="checkbox">										
											<input type="checkbox" name="eleicoesAntAnos[]" value="2010" <?php print((!is_null($objeto)) and $objeto->eleicoesAntAnos == "2010")? "checked":""; ?>>2010
										</label>
									</div>										      
								</div>
								<div class="control-group">
									...
									<div class="controls">
										<input type="text"  class="input-medium required" name="bairroPreferido1" value="<?php print ($objeto)? $objeto->bairroPreferido1:""; ?>">
									</div>
								</div>
								<hr/>
								<div class="control-group">
